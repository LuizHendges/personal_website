"""
Aula: zipfile.ZipFile
Documentação: https://docs.python.org/3/library/zipfile.html

Nesta aula vemos como criar, ler e extrair arquivos ZIP usando zipfile.ZipFile.

Principais pontos:
- Criar um diretório e gerar arquivos para compactar
- Compactar arquivos usando ZipFile no modo 'w'
- Listar conteúdo de um .zip com .namelist()
- Extrair todos os arquivos usando .extractall()

Também utilizamos os módulos os, shutil e pathlib para manipulação de caminhos e diretórios.
"""
...
# Limpando diretórios e arquivos anteriores
